...
train_x = test_data.drop("class", axis=1)
train_y = test_data.loc[:, ["class"]]

train_x = pd.get_dummies(train_x, drop_first=False, dtype=int)
train_y = pd.get_dummies(train_y, drop_first=True, dtype=int)

train_x = train_x.values
train_y = train_y.values

data_features=train_x.shape[1] #31
